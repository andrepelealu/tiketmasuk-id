  ...
  <div class="col-md-6">
    ...
    <input type="hidden" class="form-control" name="nama_" value="<?php echo $user['nama']?>">
     ...
     <div class="input-group">
       ...
       <textarea type="textarea" class="form-control" rows="5" name="tempat">
       </textarea>
     </div>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="input-group">
          ...
          <input type="number" class="form-control" name="kuota_tiket">
        </div>
        ...
        <div class="input-group">
          ...
          <input type="date" class="form-control" name="tanggal_jual_mulai">
        </div>
        ...
        <div class="input-group">
          ...
          <input type="date" class="form-control" name="tanggal_jual_selesai">
        </div>
    ...
    <div class="box box-succes">
      ...
      <div class="box-body">
        ...
        <div class="input-group">
          ...
          <textarea type="text" rows="7" class="form-control" name="deskripsi"></textarea>
        </div>
